...
export const getSearchsList = createAsyncThunk(
  "GET_SEARCH",
  searchService.getSearchsListService
)

export const addSearch = createAsyncThunk(
  "ADD_SEARCH",
  searchService.addSearchServices
)

export const deleteSearch = createAsyncThunk(
  "DELETE_SEARCH",
  searchService.deleteSearchServices
)

export const getSingleSearch = createAsyncThunk(
  "GET_ID_SEARCH",
  searchService.singleSearchServices
)

export const editRecruiter = createAsyncThunk(
  "EDIT_SEARCH",
  searchService.editSearchServices
)

export const endSearch = createAsyncThunk(
  "END_SEARCH",
  searchService.endSearchSearchServices
)

export const deleteRecruiterSearch = createAsyncThunk(
  "END_SEARCH",
  searchService.deleteRecruiterSearchServices
)

export const getAssignment = createAsyncThunk(
  "GET_ ASSIGNMENT",
  searchService.assignmentSearchsServices
)
